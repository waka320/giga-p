...
it_terms = [
    ...
    ITTerm(term="AAAAA", fullName="AAAAA",
           description="デバッグ用単語A"),
    ITTerm(term="BBBBB", fullName="BBBBB",
           description="デバッグ用単語B"),
    ITTerm(term="CCCCC", fullName="CCCCC",
           description="デバッグ用単語C"),
    ITTerm(term="DDDDD", fullName="DDDDD",
           description="デバッグ用単語D"),
    ITTerm(term="EEEEE", fullName="EEEEE",
           description="デバッグ用単語E"),
    ITTerm(term="AAAA", fullName="AAAA",
           description="デバッグ用単語A"),
    ITTerm(term="BBBB", fullName="BBBB",
           description="デバッグ用単語B"),
    ITTerm(term="CCCC", fullName="CCCCC",
           description="デバッグ用単語C"),
    ITTerm(term="DDDD", fullName="DDDDD",
           description="デバッグ用単語D"),
    ITTerm(term="EEEE", fullName="EEEEE",
           description="デバッグ用単語E"),
    ITTerm(term="AAA", fullName="AAAA",
           description="デバッグ用単語A"),
    ITTerm(term="BBB", fullName="BBBB",
           description="デバッグ用単語B"),
    ITTerm(term="CCC", fullName="CCCCC",
           description="デバッグ用単語C"),
    ITTerm(term="DDD", fullName="DDDDD",
           description="デバッグ用単語D"),
    ITTerm(term="EEE", fullName="EEEEE",
           description="デバッグ用単語E")
]
